...
TIMETABLE_DICT = {
    ...
    30: {1: "x (대기)", 2: "면접관(A반 3번 면접실)", 3: "면접관(A반 2번 면접실)", 4: "면접자(구상실)", 5: "면접자(B반 2번 면접실)"},
...
def get_room_map_html(highlight_num=None, time_filter="전체"):
    # 1) 전체 타임통합 데이터
    rooms_all = {
        "A반 1번": [("25,29<br>17,21", "top-left"), ("26,()<br>18,22", "top-right"), ("1,5,<br>9,13", "bottom-mid")],
        "A반 2번": [("27,31<br>19,23", "top-left"), ("28,30<br>20,24", "top-right"), ("2,6,<br>10,14", "bottom-mid")],
    ...
    rooms_by_time = {
        ...
        "3타임": {
            "A반 1번": [("29", "top-left"), ("-", "top-right"), ("5", "bottom-mid")],
            "A반 2번": [("31", "top-left"), ("30", "top-right"), ("6", "bottom-mid")],
